...
public class KafkaConsumer {
    ...
    private static String hdfsBasicPath = "hdfs://hadoop102:9000/user/atguigu/log-analysis/";
    ...
    public static void main(String[] args) {
        ...
        topicCount.put("analysis-log-0508", 1);
        ...
        KafkaStream<byte[], byte[]> stream = consumerMap.get("analysis-log-0508").get(0);
	...
	private static void save(String log) {
		try {
			...
			// 一致性模型  用API的流写进 HDFS的时候 只有hflush和close了outputStream才会有文件生成
			outputStream.hflush();
			outputStream.hsync();
		} catch (Exception e) {
			e.printStackTrace();
